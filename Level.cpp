...
{
	blocksTop = { floorBlock.getBoundings(), floorBlock2.getBoundings(), floorBlock3.getBoundings(), floorBlock4.getBoundings(),  platform1.getBoundings(), platform2.getBoundings() };
	blocksFloor = { floorBlock.getBoundings(), floorBlock2.getBoundings(), floorBlock3.getBoundings(), floorBlock4.getBoundings() };
	blocksInvisible = { invBlock1.getBoundings(), invBlock2.getBoundings(), invBlock3.getBoundings() };
}
